...
function App() {
  ...
  return (
    <div className="flex h-screen">
      ...
      <nav className="fixed top-16 left-0 bottom-0 w-64 bg-gray-100 p-6 shadow-md overflow-y-auto z-40">
        <div className="text-lg font-semibold mb-6">DASHBOARD</div>
        <ul>
          <li className="mb-4">
            <button
            ...
            >
              ...
              >
                <path
                  ...
                  d="M5.121 17.804A3 3 0 013 15V7a3 3 0 013-3h12a3 3 0 013 3v8a3 3 0 01-2.121 2.804M7 17a4 4 0 108 0M8 11h.01M16 11h.01"
                ></path>
              </svg>
              Profile
            </button>
            ...
            >
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M15 17h5l-1.405-5.621A2 2 0 0016.627 10H7.373a2 2 0 00-1.968 1.379L4 17h5m2 0v1a2 2 0 11-4 0v-1m4 0a2 2 0 11-4 0v-1m8-4V5a4 4 0 00-4-4H7a4 4 0 00-4 4v8"
                ></path>
              </svg>
              Notifications
            </button>
            ...
            >
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M8 12h.01M12 12h.01M16 12h.01M9 16h6m-7 4h8a2 2 0 002-2v-2.5a4.5 4.5 0 00-9 0V18a2 2 0 002 2zm1.341-4.5h4.318A2 2 0 0014 11.5V10a4.5 4.5 0 10-9 0v1.5a2 2 0 002 2z"
                ></path>
              </svg>
              Search Blood
            </button>
      ...
      {/* Content Area */}
      <main className="flex-1 ml-64 mt-16 p-6 bg-gray-100 overflow-y-auto">
        {/* Render content conditionally based on the active panel */}
        {activePanel === 'profile' && <Profile />}
        {activePanel === 'history' && <History />}
        {activePanel === 'notification' && <Notification />}
