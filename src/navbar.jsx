...
function Navbar() {
  return (
    <nav className="bg-red-800 text-white p-4 flex justify-between items-center fixed top-0 left-0 right-0 z-50 shadow-md">
      {/* Logo */}
      <div className="flex items-center">
        <img
          src="C:\Users\2023a\Documents\profile\blood-drop-plus-heart-shape-600nw-2238094877-Photoroom.png"
          alt="Logo"
      ...
      <div className="flex items-center space-x-4">
        <input
          type="text"
          placeholder="Search..."
          className="w-72 px-4 py-2 rounded-lg text-black focus:outline-none focus:ring-2 focus:ring-red-400"
        />
        ...
        <button className="px-4 py-2 rounded-xl hover:bg-red-700 transition-colors duration-200">
          Log In/Sign Out
        </button>
      </div>
    </nav>
